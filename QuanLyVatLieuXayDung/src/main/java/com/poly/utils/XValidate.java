...
import com.demojavaswing.dao.HocVienDAO;
...
//    public static NguoiHocDAO nhdao = new NguoiHocDAO();
    ...
    public static HocVienDAO hvdao = new HocVienDAO();
...
//    }
    ...
    public static boolean checkSDT(JTextField txt) {
        ...
        String rgx = "^(0|\\\\+84)(\\\\s|\\\\.)?((3[2-9])|(5[689])|(7[06-9])|(8[1-689])|(9[0-46-9]))(\\\\d)(\\\\s|\\\\.)?(\\\\d{3})(\\\\s|\\\\.)?(\\\\d{3})$";
        if (id.matches(rgx)) {
            return true;
        } else {
    ...
    public static boolean checkTrungNV(JTextField txt) {
        if (hvdao.selectById(txt.getText()) == null) {
            return true;
        } else {
